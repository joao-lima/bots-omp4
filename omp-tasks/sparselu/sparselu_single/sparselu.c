...
#pragma omp taskgroup
  ...
  {
#pragma omp task untied firstprivate(kk,bots_arg_size) depend(inout:BENCH[kk*bots_arg_size+kk][0])
    lu0(BENCH[kk*bots_arg_size+kk]);
    
    for (jj=kk+1; jj<bots_arg_size; jj++)
      if (BENCH[kk*bots_arg_size+jj] != NULL)
#pragma omp task untied firstprivate(kk,jj,bots_arg_size) depend(in:BENCH[kk*bots_arg_size+kk][0]) depend(inout:BENCH[kk*bots_arg_size+jj][0])
      {
        fwd(BENCH[kk*bots_arg_size+kk], BENCH[kk*bots_arg_size+jj]);
      }
    for (ii=kk+1; ii<bots_arg_size; ii++)
      if (BENCH[ii*bots_arg_size+kk] != NULL)
#pragma omp task untied firstprivate(kk,ii,bots_arg_size) depend(in:BENCH[kk*bots_arg_size+kk][0]) depend(inout:BENCH[ii*bots_arg_size+kk][0])
      {
...
#pragma omp task untied firstprivate(kk,jj,ii,bots_arg_size) depend(in:BENCH[ii*bots_arg_size+kk][0]) depend(in:BENCH[kk*bots_arg_size+jj][0]) depend(inout:BENCH[ii*bots_arg_size+jj][0])
            {
